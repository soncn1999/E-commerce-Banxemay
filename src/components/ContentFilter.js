...
import {
    getAllProductApi, getListBrandApi, getListProductRelateBrandApi,
    getListProductSortByPriceApi, getAllCategoryApi, getProductByCategoryApi,
    getAllProductForSearchApi, getListProductByCategoryApi
...
import blank from '../assets/order/blank.svg'
...
function ContentFilter(props) {
    ...
    useEffect(() => {
        if (option) {
            ...
            if (optionArr[0] == 'brand') {
                fireSortByBrand(optionArr[1]);
            } else if (optionArr[0] == 'category') {
                getProductByCategory(optionArr[1]);
            }
        }
        getListBrand();
        getListCategoryApi();
